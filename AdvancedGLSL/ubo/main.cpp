...
int main() {
	...
	unsigned int uboMatrics;
	glGenBuffers(1, &uboMatrics);
	glBindBuffer(GL_UNIFORM_BUFFER, uboMatrics);
	glBufferData(GL_UNIFORM_BUFFER, 2 * sizeof(glm::mat4), NULL, GL_STATIC_DRAW);
	glBindBuffer(GL_UNIFORM_BUFFER, 0);
	glBindBufferRange(GL_UNIFORM_BUFFER, 0, uboMatrics, 0, 2 * sizeof(glm::mat4));
