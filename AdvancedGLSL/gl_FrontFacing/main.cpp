...
int main() {
	...
	Shader ourShader("frontfacing.vs", "frontfacing.fs");
	...
	unsigned int backTexture = loadTexture("matrix.jpg");

	ourShader.use();
	ourShader.setInt("frontTexture", 0);
	ourShader.setInt("backTexture", 1);
